...
class OpenAIService {
    ...
    func searchTavily(query: String, apiKey: String) async throws -> TavilySearchResponse {
...
struct TavilySearchRequest: Codable {
    ...
    let includeImageDescriptions: Bool
    
    enum CodingKeys: String, CodingKey {
        case query
        case includeAnswer = "include_answer"
        case includeImages = "include_images"
        case includeImageDescriptions = "include_image_descriptions"
    }
} 